        ...
        <div class="container">
          <div class="row row-20 justify-content-md-center">
            ...
            <div class="col-md-8 col-lg-5 col-xxl-4">
              <!-- RD Mailform-->
              <form class="rd-form rd-mailform rd-form-inline-2" data-form-output="form-output-global" data-form-type="subscribe" method="post" action="https://livedemo.zemez.io/html/vistapay/bat/rd-mailform.php">
                <div class="form-wrap">
