                ...
                <div class="container">
                    <div class="row">
                                                    ...
                                                    <div class="unit-body">
                                                        <ul class="list-phones">
                                                            <li><a class="hover-text"
                                                                    href="tel:{{'+'.config('app.phone')}}">{{config('app.phone')}}</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                        ...
                        <div class="col-md-5 col-lg-6 col-lg-push-1">
                            ...
                            <p>Keep up with our always upcoming financial news. Enter your e-mail and subscribe to our
                                newsletter to get all updates right into your inbox.</p>
                            <!-- RD Mailform-->
                            <!-- RD Mailform-->
                            <form class="rd-form rd-mailform rd-form-inline form-sm"
                                data-form-output="form-output-global" data-form-type="subscribe" method="post"
                                action="https://livedemo.zemez.io/html/vistapay/bat/rd-mailform.php">
                                <div class="form-wrap">
                                    <input class="form-input" id="subscribe-form-1-email" type="email" name="email"
